...
/// Main thread: the desktop fallback, polling the global InputMap into port 0.
/// Skipped entirely unless this instance is the one the player is driving.
void Wrapper::PollDesktopInput()
{
